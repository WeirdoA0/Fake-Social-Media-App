...
final class PostViewCellNoImage: UICollectionViewCell, ICollectionViewCell {
    //MARK: Properties
    var editAction: (() -> Void)?
    ...
    private func layout(){
        [authorImage, authorName, postTitle, postText, likeButton, likesLabel, pushDetailedPostButton].forEach({
        ...
        NSLayoutConstraint.activate([
            ...
            pushDetailedPostButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -5),
